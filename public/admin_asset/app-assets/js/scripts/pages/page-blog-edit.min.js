!function (e, t, o) {
    ...
    var i = o(".select2"), n = "#content-editor-container .contents",
        l = o("#blog-feature-image"), r = t.getElementById("blog-image-text"), a = o("#blogCustomFile");
    i.each((function () {
        var e = o(this);
    ...
    content_.on('text-change', function(delta, oldDelta, source) {
        document.getElementById("contents").value = content_.root.innerHTML;
    });
