...
@section('title')
    <title data-i18n="Cate">{{__('Cate')}}</title>
@endsection
@section('vendor-css')
                        ...
                        <div class="card-header border-bottom p-1">
                            <div class="dt-action-buttons text-end">
                                <div class="dt-buttons d-inline-flex">
                                    <a href="{{route('cate-add')}}" class="dt-button create-new btn btn-primary" tabindex="0"
                            ...
                            <table class="datatables-basic table dataTable no-footer dtr-column" id="DataTables_Table_0"
                                ...
                                <tr role="row">
                                    ...
                                    <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                        ...
                                        aria-label="Email: activate to sort column ascending">{{__('type cate')}}
                                    </th>
                                    <th tabindex="0" aria-controls="DataTables_Table_0" rowspan="1"
                                        colspan="1" style="width: 261px;"
                                ...
                                @if(count(@$cates) > 0)
                                    @foreach(@$cates as $cate)
                                        <tr class="odd text-center">
                                            ...
                                            <td> {{$cate->slug}}</td>
                                            <td>{{__($cate->type)}}</td>
                                            <td>@if($cate->cateID != null) {{$cate->cateID->title}} @else {{__('parent not')}} @endif</td>
                                            <td>
