...
@section('title')
    <title data-i18n="setting">{{__('setting')}}</title>
@endsection
@section('vendor-css')
...
{{--                                    <a href="{{route('setting-add')}}" class="dt-button create-new btn btn-primary" tabindex="0"--}}
...
{{--                                                                                                      x2="12"--}}
{{--                                                                                                      y2="19"></line><line--}}
{{--                                                    x1="5" y1="12" x2="19" y2="12"></line></svg>{{__('Add New setting')}}</span>--}}
{{--                                    </a>--}}
{{--                                </div>--}}
                            </div>
                        </div>
                                        ...
                                        <tr class="odd text-center">
                                            ...
                                            <td>
                                                <div class="form-check form-check-success form-switch">
                                                    <input type="checkbox"  @if($setting->status == 0) @else checked @endif class="form-check-input" active-id="{{$setting->id}}">
                                                </div>
                                            </td>
                                            <td class="text-center">
                                                <a href="{{route('setting-update', [$setting->id])}}" class="item-edit">
                                                ...
                                                <span>&nbsp; &nbsp;</span>
{{--                                                <a data-id="{{$setting->id}}" href="{{route('setting-delete', [$setting->id])}}" class="item-delete delete-record">--}}
{{--                                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"--}}
...
@section('page-js')
    ...
    <script>
        ...
        let cancel_delete ='{{__('Cancel setting Delete!')}}'
    </script>
