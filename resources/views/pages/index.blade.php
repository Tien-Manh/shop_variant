...
@section('title')
    <title data-i18n="Dashboard">{{__('Dashboard')}}</title>
@endsection
@section('page-css')
    <link rel="stylesheet" type="text/css"
          href="{{asset('admin_asset/app-assets/css/pages/dashboard-ecommerce.min.css')}}">
    <link rel="stylesheet" type="text/css"
          href="{{asset('admin_asset/app-assets/css/plugins/charts/chart-apex.min.css')}}">
    <link rel="stylesheet" type="text/css"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="my-auto">
                                        <h4 class="fw-bolder mb-0">{{count($cates)}}</h4>
                                        <p class="card-text font-small-3 mb-0">{{__('Cates')}}</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="my-auto">
                                        <h4 class="fw-bolder mb-0">{{count($posts)}}</h4>
                            ...
                            <div class="col-xl-3 col-sm-6 col-12 mb-2 mb-sm-0">
                                <div class="d-flex flex-row">
                                    ...
                                    <div class="my-auto">
                                        <h4 class="fw-bolder mb-0">{{count($orders)}}</h4>
...
@section('page-js')
    <script src="{{asset('admin_asset/app-assets/js/scripts/pages/dashboard-ecommerce.min.js') }}"></script>
@endsection
